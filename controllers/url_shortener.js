        ...
        ShortURL.findOne({ 'url': original_url }, function(err, shortURL) {
          ...
          if (shortURL) {
            ...
            return res.json({
              ...
              short_url: (process.env.HOST || 'https://fcc-url-shortener-zklinger.herokuapp.com/') + shortURL.slug,
            ...
            ShortURL.find({}).sort('-slug').limit(1).exec(function(err, urls) {
              ...
              return res.json({
                original_url: original_url,
                short_url: (process.env.HOST || 'https://fcc-url-shortener-zklinger.herokuapp.com/') + newShortURL.slug,
